...
yakServer1 = repository.create(factory.configurationItem("Infrastructure/rules-yakRuleServer1","yak.YakServer", {"host": myhost.id }))

# Creating the Environment
yakEnv = repository.create(factory.configurationItem("Environments/rules-StepMacroNoopWithParametersEnv", "udm.Environment", {"members": [yakServer1.id]}))
...
exceptedStep2 = "Custom step description"
exceptedStep3 = "Custom step description"
