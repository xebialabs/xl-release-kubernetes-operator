# This test checks if the Credentials CI can be attached to the SMB Host Infrastructure item
credentials_ci = create_random_configuration("CREDENTIALS-CI-FOR-SMB-HOSTS", "credentials.SshHostCredentials", {"username": "api-user", "password": "api-pass"})

# attach to existing Host CI
server1 = create_random_host(
    "CREDENTAILS-SMB-HOST-1",
    "overthere.SshHost",
