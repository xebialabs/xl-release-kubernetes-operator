# This test checks if the Credentials CI can be attached to the SSH Host Infrastructure item
credentials_ci = create_random_configuration(
    "CREDENTIALS-CI-FOR-HOSTS",
    "credentials.SshHostCredentials",
    {'password': 'api-pass', 'username': 'api-user'}
)
