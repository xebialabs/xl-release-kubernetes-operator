...
assertStepState(taskId, "0_1_1_8", StepExecutionState.PENDING)
assertStepState(taskId, "0_1_1_9", StepExecutionState.PENDING)
assertStepState(taskId, "0_1_1_10", StepExecutionState.PENDING)

# Skipping tasks 8 and 10"
task2.skip(taskId, ["0_1_1_8", "0_1_1_10"])
assertStepState(taskId, "0_1_1_8", StepExecutionState.SKIP)
assertStepState(taskId, "0_1_1_9", StepExecutionState.PENDING)
assertStepState(taskId, "0_1_1_10", StepExecutionState.SKIP)

# Un-skipping tasks 8 and 10"
task2.unskip(taskId, ["0_1_1_8", "0_1_1_10"])
assertStepState(taskId, "0_1_1_8", StepExecutionState.PENDING)
assertStepState(taskId, "0_1_1_9", StepExecutionState.PENDING)
assertStepState(taskId, "0_1_1_10", StepExecutionState.PENDING)
