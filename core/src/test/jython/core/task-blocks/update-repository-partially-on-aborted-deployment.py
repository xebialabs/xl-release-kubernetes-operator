...
grazing_app_pkg = importPackage("GrazingApp/4.0")
blocker_app_pkg = importPackage("BlockerApp/3.0")
meadow = create_random_server('meadow1', 'yak.Meadow')
yak_server = create_random_yak_server('yakserver1')
env = create_random_environment('yakEnv-aborted-deployment', [meadow.id, yak_server.id])
...
print "Task is started post checkopoint"
